  ...
  const userListings = mockItems.filter(
    (item) =>
      typeof item.owner === 'string'
        ...
        : item.owner?.name?.toLowerCase() === user.name.toLowerCase()
  );
          ...
          {activeTab === 'listings' ? (
            userListings.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-2xl border border-primary/5 shadow-sm max-w-lg mx-auto">
                ...
                <h3 className="font-extrabold text-neutral-700 text-sm">No listings yet</h3>
            ...
            savedListings.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-2xl border border-primary/5 shadow-sm max-w-lg mx-auto">
                ...
                <h3 className="font-extrabold text-neutral-700 text-sm">No saved items</h3>
                <p className="text-xs text-neutral-400 mt-1 max-w-xs font-medium">
                  Explore shared resources and bookmark listings you want to keep track of.
                </p>
              </div>
            )
          )}
